...
namespace Service.Mail
{
    public class AuthenticationMail
    {
        public static MailContent SendWelcomeAndOtpToCustomer(string toEmail, string name, string otp)
        {
            ...
            mailContext.Subject = $"Chào mừng đến với Hệ thống Quản lý Phòng Trọ Nhà Nghỉ";

            mailContext.Body = $@"
    <p>Kính gửi Quý khách hàng <b>{name}</b>,</p>

    <p>Chúng tôi xin chân thành cảm ơn Quý khách đã tin tưởng và lựa chọn Hệ thống Quản lý Phòng Trọ Nhà Nghỉ của chúng tôi.</p>
    ...
    <p>Trân trọng,<br>
    Đội ngũ hỗ trợ - Hệ thống Quản lý Phòng Trọ Nhà Nghỉ</p>";
        ...
        public static MailContent SendOtpToCustomer(string toEmail, string name, string otp)
        {
            var mailContext = new MailContent();
            mailContext.To = toEmail;
            mailContext.Subject = $"Mã OTP của Quý khách từ Hệ thống Quản lý Phòng Trọ Nhà Nghỉ";
    ...
    Đội ngũ hỗ trợ - Hệ thống Quản lý Phòng Trọ Nhà Nghỉ</p>";
        ...
        public static MailContent SendWelcomeAndCredentialsToEmployee(string toEmail, string name, string password)
        {
            var mailContext = new MailContent();
            mailContext.To = toEmail;
            mailContext.Subject = $"Chào mừng đến với Hệ thống Quản lý Phòng Trọ Nhà Nghỉ";
    ...
    <p>Chào mừng anh/chị đã trở thành thành viên của đội ngũ Hệ thống Quản lý Phòng Trọ Nhà Nghỉ.</p>

    <p>Tài khoản của anh/chị đã được tạo thành công trên hệ thống. Dưới đây là thông tin tài khoản:</p>
    <ul>
        <li><b>Email đăng nhập:</b> {toEmail}</li>
